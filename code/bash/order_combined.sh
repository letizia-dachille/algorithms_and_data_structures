cat ../../paris/original/network_combined.csv | awk '{if(NR < 2) print $0 > "../../paris/ordered/network_combined_sorted.csv"; else print $0}' | sort --field-separator=';' -n -k1 -k2 -k7 >> ../../paris/ordered/network_combined_sorted.csv
