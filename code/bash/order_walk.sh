cat ../../paris/original/network_walk.csv | awk '{if(NR < 2) print $0 > "../../paris/ordered/network_walk_sorted.csv"; else print $0}' | sort --field-separator=';' -n -k1 -k2 -k3 >> ../../paris/ordered/network_walk_sorted.csv
